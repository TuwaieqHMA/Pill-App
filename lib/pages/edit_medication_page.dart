                              ...
                              if (state is MedicationLoadingState) {
                                ...
                                return Column(
                                  ...
                                  children: [
                                      ...
                                      onTap: () {
                                        medicationBloc.add(EditMedicationEvent(
                                          ...
                                          newMedication: Medication(
                                              ...
                                              startDate: (durationController.text.isNotEmpty)
                                                  ? DateTime.now()
                                                  ...
                                                  ? DateTime.now().add(Duration(
                                                      days: int.parse(durationController.text
                                                          .replaceAll(
                                                              "يوم   ", ""))))
                                                  : medication.endDate,
                                              beforeAfterEating: (beforeAfterController
                                                      .text.isNotEmpty)
                                                  ? beforeAfterController.text
                                                  : medication.beforeAfterEating,
                                              currentStatus:
                                                  medication.currentStatus,
                                              numberPill: (pillCountController.text.isNotEmpty)
                                                  ? int.parse(pillCountController.text.replaceAll("حبة     ", ""))
                                    ...
                                    BottomButton(
                                      onTap: () {
                                        medicationBloc.add(RemoveMedicationEvent(
